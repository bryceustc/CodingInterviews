...
* [LeetCode(55)：跳跃游戏](https://github.com/bryceustc/LeetCode_Note/blob/master/cpp/Jump-Game/README.md)(**重要**，动态规划、贪心,reach=max(reach,i+nums[i]))
* [LeetCode(45)：跳跃游戏II](https://github.com/bryceustc/LeetCode_Note/blob/master/cpp/Jump-Game/README.md)(**重要**，动态规划、贪心,reach=max(reach,i+nums[i]))
